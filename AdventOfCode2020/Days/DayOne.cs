...
namespace AdventOfCode2020.Days
{
    public class DayOne
    {
        public static void PartOne()
        {
            ...
            int prod = lines.SelectMany(a => lines.Select(b => (a+b, a*b))).Where(sum => sum.Item1 == 2020).First().Item2;
        ...
        public static void PartTwo()
        {
            ...
            int prod = lines.SelectMany(a => lines.Select(b => (a + b, a * b)))
                        .SelectMany(ab => lines.Select(c => (ab.Item1 + c, ab.Item2 * c))).Where(sum => sum.Item1 == 2020).First().Item2;
            Console.WriteLine($"Product of lines with sum 2020 is {prod}");
